...
def isWanted (line):
    return ('item_Name' in line or 'Item_Name' in line or 'item_name' in line) and 'item_name=物品名稱' not in line or ('vehicle_Name' in line or 'vehicle_name' in line) or 'flightHUD_Label' in line or ('operatorMode_' in line and 'ui_controlhint_ships' not in line) or ('hud_countermeasure_decoy' in line or 'hud_countermeasure_smokescreen' in line or 'hud_gimbal_mode' in line or 'hud_gyro' in line or 'hud_flt' in line)
